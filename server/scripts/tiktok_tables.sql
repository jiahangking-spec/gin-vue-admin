...
✅ SQL文件已生成: tiktok_tables.sql
========================================
  使用说明
========================================
1. 创建数据库:
   CREATE DATABASE tiktok_cloud_control DEFAULT CHARACTER SET utf8mb4;

2. 导入表结构:
   mysql -u root -p tiktok_cloud_control < tiktok_tables.sql
